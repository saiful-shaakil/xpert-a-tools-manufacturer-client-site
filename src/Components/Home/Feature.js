      ...
      <div className="relative">
        <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div className="lg:col-start-2 lg:max-w-2xl ml-auto">
            <p className="text-base leading-6 text-info font-semibold uppercase">
              Quality
            </p>
            <h4 className="mt-2 text-2xl leading-8 font-extrabold text-info dark:text-white sm:text-3xl sm:leading-9">
              What we give the best priority.
            </h4>
            <p className="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-300">
              We expert are always focus on quality. It doesn't matter to us how
              small or big product it is. We just love to improve the quality of
              our products. That's why we are always best.
            </p>
            <ul className="mt-8 md:grid md:grid-cols-2 gap-6">
              ...
              <li className="mt-6 lg:mt-0">
                <div className="flex">
                  ...
                  <span className="ml-4 text-base leading-6 font-medium text-gray-500 dark:text-gray-200">
                    Free tips to improve product quality
                  </span>
                </div>
              </li>
            </ul>
            ...
            <div className="relative space-y-4">
              <div className="flex items-end justify-center lg:justify-start space-x-4">
                <img
                  ...
                  width="200"
                  src="https://template.hasthemes.com/jantrik/jantrik/img/products/3.jpg"
                  alt="1"
                />
                <img
                  className="rounded-lg shadow-lg w-40 md:w-64"
                  width="260"
                  src="https://template.hasthemes.com/jantrik/jantrik/img/products/4.jpg"
                  alt="2"
                />
              </div>
              <div className="flex items-start justify-center lg:justify-start space-x-4 ml-12">
                <img
                  ...
                  width="170"
                  src="https://template.hasthemes.com/jantrik/jantrik/img/products/1.jpg"
                  alt="3"
                />
                <img
                  className="rounded-lg shadow-lg w-32 md:w-56"
                  width="200"
                  src="https://template.hasthemes.com/jantrik/jantrik/img/products/2.jpg"
                  alt="4"
                />
              </div>
            </div>
